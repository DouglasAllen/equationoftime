...
describe 'Tests date of "2014-08-15" ' do
  ...
  it 'expected   -0.019617664868840277 from \
      angles.eot()' do
    assert_equal(-0.019617664868840277, \
                 angles.eot)
  end
  ...
  it 'expected   -2.7528817371489427 from \
      angles.omega()' do
    assert_equal(-2.7528817371489427, \
                 angles.omega)
  end
...
describe 'Tests date of "2009-08-11" ' do
  ...
  it 'expected   -0.022580248577879585 from \
      angles.eot()' do
    assert_equal(-0.022580248577879585, \
                 angles.eot)
  end
  ...
  it 'expected   -1.0615640635264998 from \
      angles.omega()' do
    assert_equal(-1.0615640635264998, \
                 angles.omega)
  end
