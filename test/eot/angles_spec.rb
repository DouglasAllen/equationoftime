...
describe 'Tests ajd of 2456885.0 ' do
  ...
  it 'should be  2456885.0 for angles.ajd'do
    assert_equal(2_456_885.0, angles.ajd)
  end

  it 'should be  "2014-08-15T12:00:00+00:00" for angles.date'.to_s do
    assert_equal('2014-08-15T12:00:00+00:00', angles.date.to_s)
  end

  it 'should be  3.8508003966038915 for angles.ma'do
  ...
  it 'should be  -0.7943361570447028 from angles.cosine_al_sun()? ' do
    assert_equal(-0.7943361570447028, angles.cosine_al_sun)
  end

  it 'should be  -0.7943772759574919 from  angles.cosine_tl_sun()? ' do
    assert_equal(-0.7943772759574919, angles.cosine_tl_sun)
  end

  it 'should be  0.9175115346811911 from  angles.cosine_to_earth()? ' do
    assert_equal(0.9175115346811911, angles.cosine_to_earth)
  end

  it 'should be  0.24401410218543554 from  angles.dec_sun()? ' do
    assert_equal(0.24401410218543554, angles.dec_sun)
  end

  it 'should be  -4.069792718159396e-05 from  angles.delta_epsilon()? ' do
    assert_equal(-4.069792718159396e-05, angles.delta_epsilon)
  end

  it 'should be  -0.04103082558803539 from  angles.delta_oblique()? ' do
    assert_equal(-0.04103082558803539, angles.delta_oblique)
  end

  it 'should be  0.021413249720702462 from  angles.delta_orbit()? ' do
    assert_equal(0.021413249720702462, angles.delta_orbit)
  end

  it 'should be  3.75123821843003e-05 from  angles.delta_psi()? ' do
  ...
  it 'should be  2.5101912804141424 from  angles.gml_sun()? ' do
  ...
  it 'should be  2.510089864980358 from  angles.ml_aries()? ' do
    assert_equal(2.510089864980358, angles.ml_aries)
  end

  it 'should be  0.40905940254265843 from  angles.mo_earth()? ' do
    assert_equal(0.40905940254265843, angles.mo_earth)
  end

  it 'should be  -2.7528817371494685 from  angles.omega()? ' do
    assert_equal(-2.7528817371494685, angles.omega)
  end

  it 'should be  2.5297411654316497 from  angles.ra_sun()? ' do
    assert_equal(2.5297411654316497, angles.ra_sun)
  end

  it 'should be  0.6074784519729512 from  angles.sine_al_sun()? ' do
    assert_equal(0.6074784519729512, angles.sine_al_sun)
  end

  it 'should be  0.6074246812917259 from  angles.sine_tl_sun()? ' do
    assert_equal(0.6074246812917259, angles.sine_tl_sun)
  end

  it 'should be  3.8293871468831893 from  angles.ta_sun()? ' do
    assert_equal(3.8293871468831893, angles.ta_sun)
  end

  it 'should be  2.5101242776531474 from  angles.tl_aries()? ' do
    assert_equal(2.5101242776531474, angles.tl_aries)
  end

  it 'should be  2.48877803069344 from  angles.tl_sun()? ' do
    assert_equal(2.48877803069344, angles.tl_sun)
  end

  it 'should be  0.40901870461547685 from angles.to_earth()? ' do
...
describe 'Tests ajd of 2455055.5 ' do
  ...
  it 'should be  2455055.0, from angles.' do
    assert_equal(2_455_055.0, angles.ajd)
  end

  it 'should be  "2009-08-11T12:00:00+00:00", from angles.date.to_s' do
    assert_equal('2009-08-11T12:00:00+00:00', angles.date.to_s)
  end

  it 'should be  3.7871218188949207, from angles.' do
    assert_equal(3.7871218188949207, angles.ma)
  end

  it 'should be  2.4252140645725033 from angles.al_sun()? ' do
    assert_equal(2.4252140645725033, angles.al_sun)
  end

  it 'should be  -0.019768413456709915 from angles.center()? ' do
    assert_equal(-0.019768413456709915, angles.center)
  end

  it 'should be  -0.7541886969975007 from angles.cosine_al_sun()? ' do
    assert_equal(-0.7541886969975007, angles.cosine_al_sun)
  end

  it 'should be  -0.7542060769936684 from angles.cosine_tl_sun()? ' do
    assert_equal(-0.7542060769936684, angles.cosine_tl_sun)
  end

  it 'should be  0.9174818088112336 from angles.cosine_to_earth()? ' do
    assert_equal(0.9174818088112336, angles.cosine_to_earth)
  end

  it 'should be  0.2642691272294404 from angles.dec_sun()? ' do
    assert_equal(0.2642691272294404, angles.dec_sun)
  end

  it 'should be  2.2661506700250296e-05 from angles.delta_epsilon()? ' do
    assert_equal(2.2661506700250296e-05, angles.delta_epsilon)
  end

  it 'should be  -0.04234904897476355 from angles.delta_oblique()? ' do
    assert_equal(-0.04234904897476355, angles.delta_oblique)
  end

  it 'should be  0.019768413456709915 from angles.delta_orbit()? ' do
    assert_equal(0.019768413456709915, angles.delta_orbit)
  end

  it 'should be  7.639341522992976e-05 from angles.delta_psi()? ' do
  ...
  it 'should be  2.445008945789877 from  angles.gml_sun()? ' do
  ...
  it 'should be  2.444907382260759 from angles.ml_aries()? ' do
    assert_equal(2.444907382260759, angles.ml_aries)
  end

  it 'should be  0.4090707793981491 from angles.mo_earth()? ' do
    assert_equal(0.4090707793981491, angles.mo_earth)
  end

  it 'should be  -1.0615640635268548 from angles.omega()? ' do
    assert_equal(-1.0615640635268548, angles.omega)
  end

  it 'should be  2.467563113547267 from angles.ra_sun()? ' do
    assert_equal(2.467563113547267, angles.ra_sun)
  end

  it 'should be  0.6566577566139093 from angles.sine_al_sun()? ' do
    assert_equal(0.6566577566139093, angles.sine_al_sun)
  end

  it 'should be  0.6566377946979757 from angles.sine_tl_sun()? ' do
    assert_equal(0.6566377946979757, angles.sine_tl_sun)
  end

  it 'should be  3.767353405438211 from angles.ta_sun()? ' do
    assert_equal(3.767353405438211, angles.ta_sun)
  end

  it 'should be  2.4449774607872907 from angles.tl_aries()? ' do
    assert_equal(2.4449774607872907, angles.tl_aries)
  end

  it 'should be  2.4252405323331674 from angles.tl_sun()? ' do
    assert_equal(2.4252405323331674, angles.tl_sun)
  end

  it 'should be  0.4090934409048494 from angles.to_earth()? ' do
