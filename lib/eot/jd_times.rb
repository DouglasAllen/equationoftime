...
class Eot
  ...
  def astronomical_twilight_end_jd
    (local_noon_dt.ajd + ha_sun(4) / P2).to_f.round(12)
  end
  ...
  def civil_twilight_end_jd
    (local_noon_dt.ajd + ha_sun(2) / P2).to_f.round(12)
  end
  ...
  def eot_jd
    (time_eot / DAY_MINUTES).to_f.round(12)
  end
  ...
  def mean_local_noon_jd
    (@jd - @longitude / 360.0).to_f.round(12)
  end
  ...
  def nautical_twilight_end_jd
    (local_noon_dt.ajd + ha_sun(3) / P2).to_f.round(12)
  end
  ...
  def sunrise_jd
    (local_noon_dt.ajd - ha_sun(1) / P2).to_f.round(12)
  end
