...
class Eot    
  ...
  def delta_equinox()      
    ...
    ma_sun  = [-0.00001149, 0.000136, -0.5532, 129596581.0481, 1287104.79305].inject(0.0) {|p, a| p * @ta + a}	
    ...
    delta_eps_deg  = to_deg( delta_eps ) / 1000.0
    delta_psi_deg  = to_deg( delta_psi ) / 1000.0

    [ delta_eps_deg, delta_psi_deg, ma_sun, omega, ma_moon, md_moon, me_moon]
  end
