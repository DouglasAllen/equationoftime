...
describe 'EOT aliased_angles default, nil, 0' do
  ...
  # now rely on @ma and the only one really needing it is equation_of_time
  before(:each) do  
    Eot_aliased_angles.mean_anomaly()
  end

  it 'should be  280.37255100114527 returned by Eot_aliased_angles.apparent_longitude() ' do
  ...
  it 'should be  0.18004791965072248 returned by Eot_aliased_angles.cosine_apparent_longitude() ' do
  ...
  it 'should be  0.18021278917811492 returned by Eot_aliased_angles.cosine_true_longitude() ' do
  ...
  it 'should be  0.9174932093012645 returned by Eot_aliased_angles.cosine_true_obliquity()? ' do
  ...
  it 'should be   -23.032382986970642 returned by Eot_aliased_angles.declination()? ' do
  ...
  it 'should be  -0.9001861134220235 returned by Eot_aliased_angles.delta_t_ecliptic()? ' do
  ...
  it 'should be  0.08430228529567785 returned by Eot_aliased_angles.delta_t_elliptic()? ' do
  ...
  it 'should be  0.016708617 returned by Eot_aliased_angles.eccentricity_earth_orbit()? ' do
  ...
  it 'should be  -0.08430228529566448 returned by Eot_aliased_angles.equation_of_center()? ' do
  ...
  it 'should be  280.4664567 returned by Eot_aliased_angles.geometric_mean_longitude()? ' do
  ...
  it 'should be  90.90548725038606 returned by Eot_aliased_angles.horizon_angle()? ' do
  ...
  it 'should be  357.52910918055557 returned by Eot_aliased_angles.mean_anomaly()? ' do
  ...
  it 'should be  280.460622404583 returned by Eot_aliased_angles.mean_longitude_aries()? ' do
  ...
  it 'should be  23.439279444444445 returned by Eot_aliased_angles.mean_obliquity()? ' do
  ...
  it 'should be  23.439279444444445 returned by Eot_aliased_angles.mean_obliquity_of_ecliptic()? ' do
  ...
  it 'should be  23.43768541308359, returned by Eot_aliased_angles.obliquity_correction()? ' do
  ...
  it 'should be  281.2823405281263 returned by Eot_aliased_angles.right_ascension()? ' do
  ...
  it 'should be  -0.9836578402216123 returned by Eot_aliased_angles.sine_apparent_longitude()? ' do
  ...
  it 'should be  -0.9836276483591971 returned by Eot_aliased_angles.sine_true_longitude()? ' do
  ...
  it 'should be  357.4448068952599 returned by Eot_aliased_angles.true_anomaly()? ' do
  ...
  it 'should be  280.3821544147043 returned by Eot_aliased_angles.true_longitude()? ' do
  ...
  it 'should be  280.45708542258194 returned by Eot_aliased_angles.true_longitude_aries()? ' do
  ...
  it 'should be  23.43768541308359 returned by Eot_aliased_angles.true_obliquity()? ' do
...
describe 'EOT angles tjc array for jd 2455055.5 a non default value' do
  ...
  it 'should be  139.43434184626486 returned by Eot_aliased_angles.apparent_longitude(ta)? ' do
    assert_equal 139.43434184626486,            Eot_aliased_angles.apparent_longitude(ta)
  end  
  
  it 'should be  -1.1456598854951456 returned by Eot_aliased_angles.equation_of_center(ta)? ' do
    assert_equal -1.1456598854951456,            Eot_aliased_angles.equation_of_center(ta)
  end
  
  it 'should be  -0.759661230862344 returned by Eot_aliased_angles.cosine_apparent_longitude(ta)? ' do
    assert_equal -0.759661230862344,            Eot_aliased_angles.cosine_apparent_longitude(ta)
  end  
  
  it 'should be  -0.7596784308671858 returned by Eot_aliased_angles.cosine_true_longitude(ta)? ' do
    assert_equal -0.7596784308671858,            Eot_aliased_angles.cosine_true_longitude(ta)
  end
  
  it 'should be  0.9174818675792462 returned by Eot_aliased_angles.cosine_true_obliquity(ta)? ' do
    assert_equal 0.9174818675792462,            Eot_aliased_angles.cosine_true_obliquity(ta)
  end
  
  it 'should be   14.991891095131638 returned by Eot_aliased_angles.declination(ta)? ' do
     assert_equal 14.991891095131638,            Eot_aliased_angles.declination(ta)
  end
  
  it 'should be  -2.417213472457888 returned by Eot_aliased_angles.delta_t_ecliptic(ta)? ' do
    assert_equal -2.417213472457888,            Eot_aliased_angles.delta_t_ecliptic(ta)    	
  end
  
  it 'should be  1.1456598854951494 returned by Eot_aliased_angles.delta_t_elliptic(ta)? ' do
    assert_equal 1.1456598854951494,            Eot_aliased_angles.delta_t_elliptic(ta)
  end 
  
  it 'should be   0.01670457558842835 returned by Eot_aliased_angles.eccentricity_earth_orbit(ta)? ' do
     assert_equal 0.01670457558842835,            Eot_aliased_angles.eccentricity_earth_orbit(ta)
  end 

  it 'should be  140.5815171463405 returned by Eot_aliased_angles.geometric_mean_longitude(ta)? ' do
    assert_equal 140.5815171463405,            Eot_aliased_angles.geometric_mean_longitude(ta)
  end

  it 'should be  90.86266511703538 returned by Eot_aliased_angles.horizon_angle(ta)? ' do
    assert_equal 90.86266511703538,            Eot_aliased_angles.horizon_angle(ta) 
  end

  it 'should be  217.47889686561615 returned by Eot_aliased_angles.mean_anomaly(ta)? ' do
    assert_equal 217.47889686561615,            Eot_aliased_angles.mean_anomaly(ta) 
  end  
  
  it 'should be  320.5756979962098 returned by Eot_aliased_angles.mean_longitude_aries(ta)? ' do
    assert_equal 320.5756979962098,            Eot_aliased_angles.mean_longitude_aries(ta)
  end
  
  it 'should be  23.43802900354105 returned by Eot_aliased_angles.mean_obliquity(ta)? ' do
    assert_equal 23.43802900354105,            Eot_aliased_angles.mean_obliquity(ta) 
  end
  
  it 'should be  23.439319125405095 returned by Eot_aliased_angles.obliquity_correction(ta)? ' do
    assert_equal 23.439319125405095,            Eot_aliased_angles.obliquity_correction(ta)
  end  
  
  it 'should be  141.85307073330324 returned by Eot_aliased_angles.right_ascension(ta)? ' do
    assert_equal 141.85307073330324,            Eot_aliased_angles.right_ascension(ta) 
  end
  
  it 'should be  0.6503190096596503 returned by Eot_aliased_angles.sine_apparent_longitude(ta)? ' do
    assert_equal 0.6503190096596503,            Eot_aliased_angles.sine_apparent_longitude(ta) 
  end  

  it 'should be  0.6502989171720728 returned by Eot_aliased_angles.sine_true_longitude(ta)? ' do
    assert_equal 0.6502989171720728,            Eot_aliased_angles.sine_true_longitude(ta)
  end

  it 'should be  216.333236980121 returned by Eot_aliased_angles.true_anomaly(ta)? ' do
    assert_equal 216.333236980121,            Eot_aliased_angles.true_anomaly(ta)
  end
  
  it 'should be  139.43585726084535 returned by Eot_aliased_angles.true_longitude(ta)? ' do
    assert_equal 139.43585726084535,            Eot_aliased_angles.true_longitude(ta)
  end 
  
  it 'should be  320.57970857033285 returned by Eot_aliased_angles.true_longitude_aries(ta)? ' do
    assert_equal 320.57970857033285,            Eot_aliased_angles.true_longitude_aries(ta) 
  end

  it 'should be  23.439319125405095 returned by Eot_aliased_angles.true_obliquity(ta)? ' do
